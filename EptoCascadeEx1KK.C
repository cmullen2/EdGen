{
  ...
  outg->SetFileName("../EdGenOut/EptoCascadeEx1KK.root");
  ...
  TEGParticle* Xi=decay1->AddProduct(3314,"Xi-");
  TEGParticle* Kp1=decay1->AddProduct(321,"Kp1");
  TEGParticle* Kp2=decay1->AddProduct(321,"Kp2");
  TEGParticle* pim1=decay1->AddProduct(-211,"pim1");
  TEGParticle* pip1=decay1->AddProduct(211,"pip1");
