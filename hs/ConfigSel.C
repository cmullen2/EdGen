{
 ...
 FileName="../Eptopipp_low2.root";   // The input filename containing the tree
 TreeName="Reaction_Kinematics";   // The name of the tree
 OutName="Eptopipp_low_hist.root";   // The name of the output directory or file
 SelName="Plotter0";    // The name of the selector to be produced
