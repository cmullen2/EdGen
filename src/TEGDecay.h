...
inline void TEGDecay::BoostLab( ) //should try standard root boost method
{
  ...
  /* TVector3 cmZ=fP4->Vect().Unit(); */
  /* TVector3 cmY=labZ.Cross(cmZ).Unit(); */
  /* TVector3 cmX=cmZ.Cross(cmY).Unit(); */
  
  /* TLorentzVector tt=*fP4; */
  /* if(cmZ.Z()>=0) */
  /*   labZ.Rotate((TMath::Pi()-thR),-cmY); */
  /* else */
  /*   labZ.Rotate(thR,cmY); */
  /* labZ.Print(); */
  
  /*  cout<<thR*TMath::RadToDeg()<<endl;  */
  /* cmZ.Print(); */
  /* cmY.Print(); */
  /* cmX.Print(); */
  /* tt.Print() */;
  ...
  for ( Int_t n=0; n<fNd; n++ ){
    ...
    //fP4d[n]->Print();
  /*  if(cmZ.Z()>=0) */
  /*   fP4d[n]->Rotate(thR,cmY); */
  /*  //fP4d[n]->Rotate((TMath::Pi()-thR),-cmY); */
  /* else */
  /*   fP4d[n]->Rotate((TMath::Pi()-thR),-cmY); */
   // fP4d[n]->Rotate(thR,cmY);
   //fP4d[n]->RotateZ(phiR);
