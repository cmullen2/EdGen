{
  ...
  outg->SetFileName("../EdGenOut/EptoXto3piCharged1month25_45_100_tmin.root");
  ...
  TF1* Xmass=new TF1("Xmass","pol0(0)",0.45,3.6);
  ...
  Double_t time=1*60*60*24*1*30/10/100; //seconds
